...
type ActiveDevice struct {
	...
	IsAll     bool     `json:"isAll" validate:"required"`
}

type ActiveDeviceResult struct {
	Id             string `json:"id"`
	DisplayName    string `json:"displayName"`
	ProcessSuccess bool   `json:"processSuccess"`
	ActiveStatus   string `json:"activeStatus"`
...
func ToDeviceModel(dto Device) models.Device {
	...
	d.ProfileId = dto.ProfileId
	d.ActiveStatus = dto.ActiveStatus
	d.CloudDeviceId = dto.CloudDeviceId
	return d
}
...
func FromDeviceModelToDTO(d models.Device) Device {
	...
	dto.ProfileId = d.ProfileId
	dto.ActiveStatus = d.ActiveStatus
	dto.CloudDeviceId = d.CloudDeviceId
	return dto
}
