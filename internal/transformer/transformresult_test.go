...
func TestTransformReadResult_base_unt8(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeUint8 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeUint8)
	}
}
...
func TestTransformReadResult_base_unt16(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeUint16 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeUint16)
	}
}
...
func TestTransformReadResult_base_uint32(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeUint32 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeUint32)
	}
}
...
func TestTransformReadResult_base_uint64(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeUint64 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeUint64)
	}
}
...
func TestTransformReadResult_base_int8(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeInt8 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeInt8)
	}
}
...
func TestTransformReadResult_base_int16(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeInt16 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeInt16)
	}
}
...
func TestTransformReadResult_base_int32(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeInt32 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeInt32)
	}
}
...
func TestTransformReadResult_base_int64(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeInt64 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeInt64)
	}
}
...
func TestTransformReadResult_base_float32(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeFloat32 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeFloat32)
	}
}
...
func TestTransformReadResult_base_float64(t *testing.T) {
	...
	if cv.Type != contracts.ValueTypeFloat64 {
		t.Fatalf("Unexpect test result, value type '%v' should be '%v'", cv.Type, contracts.ValueTypeFloat64)
	}
}
