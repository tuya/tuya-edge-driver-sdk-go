...
func TestNewCommandValue(t *testing.T) {
	// Test Bool
	cv, err := NewCommandValue("resource", 0, true, contracts.ValueTypeBool)
	...
	// Test int8
	cv, err = NewCommandValue("resource", 0, int8(5), contracts.ValueTypeInt8)
	...
	// Test int16
	cv, err = NewCommandValue("resource", 0, int16(5), contracts.ValueTypeInt16)
	...
	// Test int32
	cv, err = NewCommandValue("resource", 0, int32(5), contracts.ValueTypeInt32)
	...
	// Test int64
	cv, err = NewCommandValue("resource", 0, int64(5), contracts.ValueTypeInt64)
	...
	// Test uint8
	cv, err = NewCommandValue("resource", 0, uint8(5), contracts.ValueTypeUint8)
	...
	// Test uint16
	cv, err = NewCommandValue("resource", 0, uint16(5), contracts.ValueTypeUint16)
	...
	// Test uint32
	cv, err = NewCommandValue("resource", 0, uint32(5), contracts.ValueTypeUint32)
	...
	// Test uint64
	cv, err = NewCommandValue("resource", 0, uint64(5), contracts.ValueTypeUint64)
	...
	// Test float32
	cv, err = NewCommandValue("resource", 0, float32(5.8), contracts.ValueTypeFloat32)
	...
	// Test float64
	cv, err = NewCommandValue("resource", 0, float64(5.8), contracts.ValueTypeFloat64)
	...
	// Test string
	cv, err = NewCommandValue("resource", 0, "test value", contracts.ValueTypeString)
	...
	// Test binary
	cv, err = NewCommandValue("resource", 0, []byte{1, 2, 3, 5, 8, 13}, contracts.ValueTypeBinary)
...
func TestNewFloat32Value(t *testing.T) {
	...
	if cv.ValueToString(models.Base64Encoding) != "AAAAAQ==" {
	...
	if cv.ValueToString(models.Base64Encoding) != "f3///w==" {
...
func TestNewFloat64Value(t *testing.T) {
	...
	if cv.ValueToString(models.Base64Encoding) != "AAAAAAAAAAE=" {
	...
	if cv.ValueToString(models.Base64Encoding) != "f+////////8=" {
...
// encodeMockEvent accepts a models.Event and returns a CBOR encoded byte array
